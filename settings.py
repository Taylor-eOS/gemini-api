...
#CODING_INSTRUCTION = "This is a decompilers C-style reconstruction of a function from the executable of the video game Rome Total War. If you were trying to find the function where the game calculates unit casualties after a battle, what would you look at next?"
